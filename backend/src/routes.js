...
routes.post('/api/resetPass', verifyTokenAdmin, AuthController.updatePasswordAdmin);
...
routes.post('/api/contracheque', verifyToken, ContrachequeController.create_a_contracheque);
routes.get('/api/contracheque', verifyToken, ContrachequeController.read_a_contracheque);
routes.get('/api/contracheque/:data', verifyToken, ContrachequeController.read_a_contracheque_date);
routes.delete('/api/contracheque', verifyTokenAdmin, ContrachequeController.delete_a_contracheque);

//Routes to noticias
routes.post('/api/noticia', verifyTokenAdmin, NoticiaController.create_a_noticia);
...
routes.delete('/api/noticia', verifyTokenAdmin, NoticiaController.delete_a_noticia);
routes.post('/api/noticia/edit', verifyTokenAdmin, NoticiaController.update_a_noticia);
routes.get('/api/noticias/search/:search', verifyToken, NoticiaController.get_noticias_by_search_query);
...
routes.post(
	...
	FileController.save_pdf
);
routes.post('/api/image', verifyTokenAdmin, busboy(), FileController.save_image);
